...
QT_MOC_LITERAL(1, 6, 9), // "intoFocus"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 6), // "Arrow*"
QT_MOC_LITERAL(4, 24, 5), // "arrow"
QT_MOC_LITERAL(5, 30, 8), // "outFocus"
QT_MOC_LITERAL(6, 39, 4) // "move"

    },
    "Arrow\0intoFocus\0\0Arrow*\0arrow\0outFocus\0"
    "move"
};
...
void Arrow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->intoFocus((*reinterpret_cast< Arrow*(*)>(_a[1]))); break;
        case 1: _t->outFocus(); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Arrow* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Arrow::*)(Arrow * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arrow::intoFocus)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Arrow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arrow::outFocus)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Arrow::intoFocus(Arrow * _t1)
{
